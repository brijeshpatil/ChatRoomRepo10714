...
namespace ChatRoom
{
    ...
    public class ChatService
    {
        ...
        public void RegisterFacultyByService(string FirstName, string LastName, string Gender, DateTime DateOfBirth, string EmailID, string Password, int TechnologyID, int LocationID, DateTime RegistrationDate)
        {
            cmd = new SqlCommand("RegisterFacultyByService", con);
            cmd.CommandType = CommandType.StoredProcedure;
